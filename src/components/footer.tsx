            ...
            <div className="container mx-auto px-4">
                ...
                <div className="text-center mb-6">
                    <h3 className="font-bold text-lg mb-2">Stay Connected</h3>
                     <p className="text-sm text-gray-800 mb-4">Follow us for the latest updates, schemes, and tips:</p>
                ...
                <div className="border-t border-gray-400 pt-6 text-center text-xs text-gray-700 space-y-2">
                    <div>
